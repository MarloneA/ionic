...
appControllers.controller('defaultUserInterfaceCtrl', function(APIBASE, APIBASE_V1, $mdDialog, $mdBottomSheet, $mdToast, $mdDialog, $firebaseArray, $firebaseObject, $scope, $rootScope, $timeout, $http, $filter, $q, $interval, $state, $stateParams, $ionicHistory, FileUploader) {
   ...
   //CUSTOM CODE
        ...
        var FBSalesref = firebase.database().ref().child('puchases');
        var FBProdsref = firebase.database().ref().child('products');
        ...
        var theSale;
        var dbSalesData = [];
        var FBExpensesref = firebase.database().ref().child('expenses');
        var theExpense;
        var dbExpensesData = [];
        var d = new Date();
        ...
        FBProdsref.orderByKey().on("value", function(snapshot) {
            ...
            $scope.sellItems = function() {
                ...
                var thePurchaseExpense = {
                    ...
                    'itemType': 'COGS',
                    'itemDesc': 'New Stock',
                    'imgUrl':'http://www.lfasearch.com/pwc_app/uploads/unnamed.png',
...
//File Uploader and camera
        ...
        var uploader = $scope.uploader = new FileUploader({
            url: 'http://lfasearch.com/pwc_app/tujivunie_v2.4/scripts/upload.php'
        });
        // FILTERS
        // a sync filter
